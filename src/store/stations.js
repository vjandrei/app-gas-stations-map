export const state = () => ({
  data: [
    ...
    },
    {
      ...
      coords: { lat: 25.7775449, lng: 62.2660207 },
      products: ['Biokaasu'],
      type: ['biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Mustankorkea Oy',
    ...
    },
    {
      ...
      address: 'Vasarakatu 29, 40320 Jyväskylä (K-Citymarket)',
      coords: { lat: 26.9756412, lng: 60.5423718 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['naturalgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 26.6611027, lng: 60.8728741 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['naturalgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 27.5985875, lng: 62.8458982 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['naturalgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 25.7205951, lng: 60.9625367 },
    ...
    },
    {
      ...
      coords: { lat: 25.6561602, lng: 60.9658298 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['naturalgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 28.1807456, lng: 61.0454722 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['naturalgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 25.8724165, lng: 62.323538 },
      products: ['Biokaasu'],
      type: ['biogas'],
    ...
    },
    {
      ...
      coords: { lat: 23.7565049, lng: 61.4101681 },
      products: ['Maakaasu'],
      type: ['naturalgas'],
    ...
    },
    {
      ...
      coords: { lat: 22.3953879, lng: 60.4680333 },
      products: ['Nesteytetty maakaasu (LNG)'],
      type: ['naturalgas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 24.2147429, lng: 60.2995964 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['naturalgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 24.0636903, lng: 24.0636903 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['naturalgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 27.2983255, lng: 61.6871876 },
      products: ['Biokaasu'],
      type: ['biogas'],
      payments: ['Pankki- & luottokortit'],
    ...
    },
    {
      ...
      coords: { lat: 27.2019719, lng: 62.0214982 },
      products: ['Biokaasu'],
      type: ['biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Etelä-Savon Energia Oy',
    ...
    },
    {
      ...
      coords: { lat: 21.7588306, lng: 63.1362158 },
      products: ['Biokaasu'],
      type: ['biogas'],
      payments: ['Pankki- & luottokortit'],
    ...
    },
    {
      ...
      coords: { lat: 25.3079824, lng: 60.6296491 },
      products: ['Biokaasu'],
      type: ['biogas'],
      payments: ['Pankki- & luottokortit'],
    ...
    },
    {
      ...
      coords: { lat: 23.49921, lng: 61.4770308 },
      products: ['Maakaasu', 'Biokaasu'],
    ...
    },
    {
      ...
      coords: { lat: 25.5270311, lng: 64.9590103 },
      products: ['Biokaasu'],
      type: ['biogas'],
      payments: ['Pankki- & luottokortit'],
    ...
    },
    {
      ...
      coords: { lat: 25.4589593, lng: 64.9989208 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 25.5371189, lng: 65.0566108 },
      products: ['Biokaasu'],
      type: ['biogas'],
      payments: ['Pankki- & luottokortit'],
    ...
    },
    {
      ...
      coords: { lat: 25.4397162, lng: 64.9870725 },
      products: ['Nesteytetty maakaasu (LNG)'],
      type: ['neutralgas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 22.7612686, lng: 63.6627166 },
      products: ['Biokaasu'],
      type: ['biogas'],
      payments: ['Pankki- & luottokortit'],
    ...
    },
    {
      ...
      coords: { lat: 21.7810848, lng: 61.4771953 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 25.6190599, lng: 60.3959959 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 22.2255832, lng: 60.4939738 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 24.7358615, lng: 60.720719 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 23.1630824, lng: 60.4191855 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 22.9264104, lng: 62.7652223 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 23.6767844, lng: 61.5145556 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 23.7824393, lng: 61.4794939 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 22.2129648, lng: 60.4473036 },
    ...
    },
    {
      ...
      coords: { lat: 25.0482064, lng: 60.3984176 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
    ...
    },
    {
      ...
      coords: { lat: 22.6044955, lng: 63.415413 },
      products: ['Biokaasu'],
      type: ['biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Jepuan Biokaasu Oy (Jippo Biogas Ab)',
    ...
    },
    {
      ...
      coords: { lat: 21.7178, lng: 63.052135 },
      products: ['Biokaasu'],
      type: ['biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'BIG Biokaasu',
    ...
    },
    {
      ...
      coords: { lat: 24.815358, lng: 60.2794646 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      coords: { lat: 25.0817227, lng: 60.2782306 },
      products: ['Maakaasu', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
    ...
    },
    {
      ...
      address: 'Porttisuontie 18, 01200 Vantaa (IKEA)',
      coords: { lat: 24.9131151, lng: 60.2931696 },
      products: ['Maakaasu', 'Nesteytetty maakaasu (LNG)', 'Biokaasu'],
      type: ['neutralgas', 'biogas'],
      payments: ['Pankki- & luottokortit'],
      operator: 'Gasum Oy',
